  ...
  return (
    <View style={styles.termsCondition}>
      ...
      >
        ...
        />
        <View
          style={[styles.itemwallettransactionsInner, styles.borderBorder]}
        />
        <Image
      ...
      >
        ...
        <Image
          ...
          resizeMode="cover"
          source={require("../assets/frame-2163.png")}
        />
        <View
          style={[styles.itemwallettransactionsInner, styles.borderBorder]}
        />
      ...
      <View style={[styles.buttontertiarylargeiconlef, styles.buttonFlexBox]}>
        <Image
      ...
      >
        <Text style={[styles.button1, styles.textTypo]}>Make Payment</Text>
      </Pressable>
      ...
      >
        <View style={[styles.navigationtopNav, styles.navigationtopLayout]}>
          ...
          <Image
            style={[
              styles.solidarrowSmLeftIcon,
              styles.iconchevronleftPosition,
            ]}
            resizeMode="cover"
            source={require("../assets/solidarrowsmleft2.png")}
          />
        </View>
      </View>
    </View>
