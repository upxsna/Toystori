...
const Onboarding = () => {
  ...
  return (
    <View style={[styles.onboarding, styles.onboardingLayout]}>
      ...
      />
      <Pressable
        style={[styles.onBoarding3Skip, styles.boarding3Position]}
        onPress={() => navigation.navigate("Home8")}
      >
        <Text style={[styles.skip, styles.skipTypo]}>Skip</Text>
      </Pressable>
      <Pressable
        style={[styles.onBoarding3Next, styles.boarding3Position]}
        onPress={() => navigation.navigate("Login")}
      >
        <Text style={[styles.next, styles.skipTypo]}>Next</Text>
      </Pressable>
      <View style={styles.onBoarding3Message}>
        <Text
          style={[styles.chatWithOther, styles.timeLayout]}
        >{`Chat with other members of the community to swap toys ensured with sanitized and safe packaging `}</Text>
        <Text style={styles.swap}>Swap</Text>
      </View>
      <Image
        style={styles.onBoarding3Button}
        resizeMode="cover"
        source={require("../assets/on-boarding-3-button.png")}
      />
      ...
      <Image
        style={styles.onBoarding3Image}
        resizeMode="cover"
        source={require("../assets/on-boarding-3-image.png")}
      />
    </View>
  );
};
